    ...
    public partial class frmAddEditTest : Form
    {
        ...
        public frmAddEditTest(int _LocaIDORAppointmentID, int enMode, bool LookeFlage = false, bool FlageUpdate = false)
        {
            ...
            else
            {
                ...
                testAppointment.CreatedByInfo = clsCurrentUsersInfo.CurrentUser;
            }
            switch(enMode)
            {
                case 2: // Written Test
        ...
        private void frmEditVison_Load(object sender, EventArgs e)
        {
            ...
            if (NumOfTrail > 0)
            {
                ...
                Retakeapplication  = clsApplication.FindAppByPersonID(testAppointment.LocalAppInfo.ApplicationInfo.PersonInfo.Id);
                if (Retakeapplication == null)
                {
                    ...
                    Retakeapplication.CreatedbyInfo = clsCurrentUsersInfo.CurrentUser;
