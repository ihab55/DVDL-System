...
namespace DVLD_Full_Project
{
    public partial class frmNewInternational : Form
    {
        ...
        {
            frmLicenseHistory frm = new frmLicenseHistory(internationalLicense.DriverInfo.PersonInfo.Id);
            frm.ShowDialog();
        }
        ...
        private void frmNewInternational_Load(object sender, EventArgs e)
        {
            ...
            internationalLicense.CreatedByUserInfo = internationalLicense.ApplicationInfo.CreatedbyInfo = clsCurrentUsersInfo.CurrentUser;
