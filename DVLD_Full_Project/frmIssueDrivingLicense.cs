...
namespace DVLD_Full_Project
{
    public partial class frmIssueDrivingLicense : Form
    {
        ...
        {
            clsDriver driver;
            if (clsDriver.IsExist(LocalApp.ApplicationInfo.PersonInfo.Id))
            {
                driver = clsDriver.FindByPersonId(LocalApp.ApplicationInfo.PersonInfo.Id);
            }
            else
            {
                driver = new clsDriver();
                driver.PersonInfo = LocalApp.ApplicationInfo.PersonInfo;
                driver.CreatedByInfo = clsCurrentUsersInfo.CurrentUser;
            ...
            if (driver.Save())
            {
                ...
                license.CreatedByUserInfo = clsCurrentUsersInfo.CurrentUser;
