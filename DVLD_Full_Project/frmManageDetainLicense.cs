...
namespace DVLD_Full_Project
{
    public partial class frmManageDetainLicense : Form
    {
        ...
        {
            frmCardDetailsPerson frm = new frmCardDetailsPerson((string)dataGridView1.CurrentRow.Cells[6].Value);
            frm.ShowDialog();
        }
        ...
        {
            frmRelaseDetainLicense frm = new frmRelaseDetainLicense((int)dataGridView1.CurrentRow.Cells[0].Value);
            frm.ShowDialog();
        }
    }
}
